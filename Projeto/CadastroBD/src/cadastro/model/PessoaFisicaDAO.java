...
public class PessoaFisicaDAO {
    ...
    public PessoaFisica getPessoa(Integer id) throws SQLException {
        String sql = "SELECT Pessoa.idPessoa, Pessoa.nome, Pessoa.logradouro, Pessoa.cidade, Pessoa.estado, Pessoa.telefone, Pessoa.email, PF.cpf \n"
                + "FROM Pessoa AS Pessoa JOIN PessoaFisica AS PF ON Pessoa.idPessoa = PF.Pessoa_idPessoa WHERE Pessoa.idPessoa = ?;";
