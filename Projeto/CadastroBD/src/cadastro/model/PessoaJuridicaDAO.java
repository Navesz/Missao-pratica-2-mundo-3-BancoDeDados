...
public class PessoaJuridicaDAO {
    ...
    public PessoaJuridica getPessoa(int id) throws SQLException {
        final String sql = "SELECT Pessoa.idPessoa, Pessoa.nome, Pessoa.logradouro, Pessoa.cidade, Pessoa.estado, Pessoa.telefone, Pessoa.email, PJ.cnpj\n"
                + "FROM Pessoa AS Pessoa JOIN PessoaJuridica AS PJ ON Pessoa.idPessoa = PJ.Pessoa_idPessoa WHERE Pessoa.idPessoa = ?;";
    ...
    public void incluir(PessoaJuridica pessoa) throws SQLException {
        ...
        final String sqlPessoaJuridica = "INSERT INTO PessoaJuridica (Pessoa_idPessoa, cnpj) VALUES (?, ?)";
    ...
    public void alterar(PessoaJuridica pessoa) throws SQLException {
        ...
        final String sqlPessoaJuridica = "UPDATE PessoaJuridica SET cnpj = ? WHERE Pessoa_idPessoa = ?";
